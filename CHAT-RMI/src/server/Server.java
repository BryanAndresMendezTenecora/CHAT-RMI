...
public class Server extends UnicastRemoteObject implements InterfazRemoto {
	...
	public static void main(String[] args) {
		...
		try{
			InterfazRemoto hello = new Server();
			Naming.rebind("rmi://" + hostName + "/" + serviceName, hello);
			System.out.println("Server corriendo perfectamente...");
		}
		catch(Exception e){
	...
	public void actualizarChat(String name, String nextPost) throws RemoteException {
	...
	private void registerChatter(String[] details){		
		try{
			InterfazCliente nextClient = ( InterfazCliente )Naming.lookup("rmi://" + details[1] + "/" + details[2]);
